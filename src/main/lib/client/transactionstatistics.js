...
const blockchain_1 = require("../comm/blockchain");
class TransactionStatistics {
    ...
    print(label) {
        ...
        let r;
        if (blockchain_1.default.mergeDefaultTxStats(statistics) === 0) {
            r = blockchain_1.default.createNullDefaultTxStats;
            r.label = label;
        }
        else {
            r = statistics[0];
...
exports.default = TransactionStatistics;
//# sourceMappingURL=transactionstatistics.js.map